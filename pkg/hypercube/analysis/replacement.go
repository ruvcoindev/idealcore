...
import (
	//"time"
	"github.com/ruvcoindev/idealcore/pkg/hypercube/core"   // ПРАВИЛЬНО
	"github.com/ruvcoindev/idealcore/pkg/hypercube/data"   // ПРАВИЛЬНО
	"github.com/ruvcoindev/idealcore/pkg/hypercube/model"  // НУЖНО ДОБАВИТЬ
)
